...
namespace Vuforia
{
    ...
    /// </summary>
    public class CardSheepTrackableEvantHandler : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        private GameObject SheepMarker;
        ...
        void Start()
        {
            ...
            SheepMarker = GameObject.Find("Card_Sheep");
                                        ...
                                        TrackableBehaviour.Status newStatus)
        {
                ...
                newStatus == TrackableBehaviour.Status.EXTENDED_TRACKED)
            {
                ...
                //양치기 소년 마커 찾음
                if (mTrackableBehaviour.TrackableName == "Card_Sheep")
                {
                    mMarkerStateManager.setSheepMarker(MarkerStateManager.StateType.On);
                    Debug.Log(mMarkerStateManager.getSheepMarker());
                }
            ...
            else
            {
                ...
                if (mTrackableBehaviour.TrackableName == "Card_Sheep")
                {
                    mMarkerStateManager.setSheepMarker(MarkerStateManager.StateType.Off);
