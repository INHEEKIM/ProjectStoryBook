...
namespace Vuforia
{
    ...
    /// </summary>
    public class CardPeopleTrackableEvantHandler : MonoBehaviour,
                                                ITrackableEventHandler
    {
        ...
        void Start()
        {
            ...
            PeopleMarker = GameObject.Find("Card_People");
                                        ...
                                        TrackableBehaviour.Status newStatus)
        {
                ...
                newStatus == TrackableBehaviour.Status.EXTENDED_TRACKED)
            {
                ...
                //양치기 소년 마커 찾음
                if (mTrackableBehaviour.TrackableName == "Card_People")
                {
                    mMarkerStateManager.setPersonsMarker(MarkerStateManager.StateType.On);
                    Debug.Log(mMarkerStateManager.getPersonsMarker());
                }
            ...
            else
            {
                ...
                if (mTrackableBehaviour.TrackableName == "Card_People")
                {
                    mMarkerStateManager.setPersonsMarker(MarkerStateManager.StateType.Off);
